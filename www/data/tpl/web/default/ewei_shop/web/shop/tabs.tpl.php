<?php defined('IN_IA') or exit('Access Denied');?><ul class="nav nav-tabs">
    ...
    <?php if(cv('shop.goods.view')) { ?><li <?php  if($_GPC['p'] == 'goods' || empty($_GPC['p'])) { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl('shop/goods')?>">商品管理</a></li><?php  } ?>  
     <?php if(cv('shop.stock.view')) { ?><li <?php  if($_GPC['p'] == 'stock') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl('shop/stock')?>">商品库存管理</a></li><?php  } ?>
    ...
    <?php if(cv('shop.notice.view')) { ?><li <?php  if($_GPC['p'] == 'notice') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl('shop/notice')?>">健康资源管理</a></li><?php  } ?>
