...
<div class="cart">
    ...
    <a href="<?php  echo $this->createPluginMobileUrl('commission/shares',array('f'=>'center'))?>">
    	<div class="list1" style="margin:0px; border-bottom:0px;">
    		<i class="fa fa-qrcode" style="color:#53bdec;"></i>我的推广链接
    		<i class="fa fa-angle-right" style="color:#999; font-size:26px; float:right; line-height:44px;"></i>
    	</div>
    </a>
</div>
