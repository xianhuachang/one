                        ...
                        <div class='input-group'>
                           <span class='input-group-addon'>订单数量满</span>
                            ...
                            <input type="text" name="ordermoney" class="form-control" value="<?php  echo $level['ordermoney'];?>" />
                             ...
                             <span class='input-group-addon'>充值金额满</span>
                            <input type="text" name="orderrechargemoney" class="form-control" value="<?php  echo $level['orderrechargemoney'];?>" />
                            <span class='input-group-addon'>元</span>
                        </div>
                        <span class='help-block'>会员升级条件，不填写默认为不自动升级</span>
                         <?php  } else { ?>
                           <div class='form-control-static'>
                                <?php  if(!empty($level['orderrechargemoney'])) { ?>
                                 充值金额满 <?php  echo $level['orderrechargemoney'];?> 元 
                               <?php  } else { ?>
                               不自动升级
                               <?php  } ?>                       
                           </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php  echo $row['levelname'];?></td>
                           <td>
                                <?php  if(!empty($row['orderrechargemoney'])) { ?>
                                 充值金额满 <?php  echo $row['orderrechargemoney'];?> 元 
                               <?php  } else { ?>
                               不自动升级
                               <?php  } ?>
                          </td>                            
