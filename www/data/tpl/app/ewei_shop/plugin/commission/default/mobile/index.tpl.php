...
<style type="text/css">
    ...
    .menu .nav4 {border-bottom:1px solid #f1f1f1;border-right:1px solid #f1f1f1; text-align:center;} .menu .nav4 i { color:#ca81d1}
    .menu .nav5 {border-bottom:1px solid #f1f1f1;border-right:1px solid #f1f1f1; text-align:center;} .menu .nav5 i { color:#53bdec}
    .menu .nav6 {border-bottom:1px solid #f1f1f1; text-align:center;} .menu .nav6 i { color:#aadaf6}
    .menu .nav7 {border-bottom:1px solid #f1f1f1; text-align:center; border-right:1px solid #f1f1f1; } .menu .nav7 i { color:#f3d110}
...
<script id='tpl_main' type='text/html'>
    ...
    <div class="menu">  
        ...
        <%if set.openselect%>
        <a href="<?php  echo $this->createPluginMobileUrl('commission/myshop/select')?>"><div class="nav nav7"><i class="fa fa-star  fa-3x"></i><div class="title">自选商品</div><div class="con">选择我喜欢的商品</div></div></a>
        <%/if%>
