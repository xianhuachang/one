<?php defined('IN_IA') or exit('Access Denied');?><?php (!empty($this) && $this instanceof WeModuleSite || 1) ? (include $this->template('web/_header', TEMPLATE_INCLUDEPATH)) : (include template('web/_header', TEMPLATE_INCLUDEPATH));?> <?php (!empty($this) && $this instanceof WeModuleSite || 1) ? (include $this->template('web/order/tabs', TEMPLATE_INCLUDEPATH)) : (include template('web/order/tabs', TEMPLATE_INCLUDEPATH));?>
<style type='text/css'>
	.trhead td {
		background: #efefef;
		text-align: center
...
<table class='table' style='float:left;border:1px solid #ccc;margin-top:5px;margin-bottom:5px;table-layout: fixed'>
	...
	<?php  if(is_array($item['goods'])) { foreach($item['goods'] as $index => &$g) { ?>
	<tr class='trbody'>
		<td valign='top'><?php  echo $g['title'];?> / <?php  echo $g['goodssn'];?></td>
		<td style='border-left:none'><?php  echo $g['goods_total'];?></td>
		<td style='border-left:none'><?php  echo $g['sended'];?></td>
		<td style='border-left:none'><label style="color: red;"><?php  echo $g['owe'];?></label></td>
		<?php  if($index==0 && $goodsCount>1) { ?>	
		...
		<?php  } else if($index==0 && $goodsCount==1) { ?>
...
<?php  } } ?>
 ...
 <?php  echo $pager;?> <?php (!empty($this) && $this instanceof WeModuleSite || 1) ? (include $this->template('web/_footer', TEMPLATE_INCLUDEPATH)) : (include template('web/_footer', TEMPLATE_INCLUDEPATH));?>