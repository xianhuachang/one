    ...
    <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu">
                ...
                <?php if(cv('shop.notice')) { ?><li><a href="<?php  echo $this->createWebUrl('shop/notice')?>">健康资源管理</a></li><?php  } ?>
        ...
        <li>
            <a href='javascript;:' class="dropdown-toggle" data-toggle="dropdown"><i class='fa fa-file-text-o'></i> 订单管理 <i class="fa fa-angle-down"></i></a>
             <ul class="dropdown-menu">
                <?php if(cv('order.view.status0|order.view.status1|order.view.status2|order.view.status3|order.view.status4|order.view.status_1|order.view.status5')) { ?>
            	...
            	<?php if(cv('order.view.status5')) { ?><li ><a href="<?php  echo $this->createWebUrl('order', array('op' => 'maintain', 'maintain' => 1))?>">维护订单</a></li><?php  } ?>
             </ul>
        </li>
        <?php  } ?>
          <?php if(cv('finance')) { ?>
        ...
        <li class="dropdown">
           <a href='javascript:;' class="dropdown-toggle" data-toggle="dropdown"><i class='fa fa-cubes'></i> 管家管理 <i class="fa fa-angle-down"></i></a>
            <ul class="dropdown-menu">
