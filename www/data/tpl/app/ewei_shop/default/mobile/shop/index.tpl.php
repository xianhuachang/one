...
<style type="text/css">
    ...
    .banner .menu {height:45px; width:100%; background:rgba(0,0,0,0.3); position: absolute; bottom: 0;}
    .banner .menu .nav {height:40px; width:25%; padding-top:5px; float:left; text-align:center; font-size:12px; color:#fff;}
    .banner .menu .navon {height:37px; border-bottom:3px solid #dd2322;}
    .banner .menu .nav i {font-size:18px;}
    ...
    .goods .good {overflow:hidden; width:29%; padding:0px 2% 10px; float:left;}/*width:46%*/
...
<!--        <div class="list" onclick="location.href='<?php  echo $this->createMobileUrl('shop/category')?>'"><i class="fa fa-list"></i> 分类</div>-->
        <div class="topbar">
          ...
          <!--  <div class="menu">
                ...
                <div class="nav"  data-op='notice'><i class="fa fa-volume-up"></i><br>健康资源</div>
            </div> -->
        </div>
    </div>
    ...
    <div class="banner">
        ...
        <%if advs.length>1%>
        <div class="flicking_con" style="display: none"><div class="inner">
...
<script type="text/javascript">
	/*window.onload=function(){
		 <?php  if($isCompleteData==TRUE) { ?>
		 	alert("您好,请先完善个人资料,谢谢!");
		 	window.location.href="<?php  echo $this->createMobileUrl('member/info')?>";
		 <?php  } ?>
	}*/
</script>
