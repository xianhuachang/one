	...
	<form class="form-horizontal form" action="" method="post">
		...
		<div class="form-group">
			...
			<div class="col-sm-10 col-xs-12">
				<input type="text" class="form-control" placeholder="请使用字母或数字或下划线组合字段名" name="field"  value="<?php  echo $item['field'];?>" <?php  if(!empty($item['field'])) { ?>readonly<?php  } ?>>
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-sm-10 col-xs-12">
				<select class="form-control" name="length" >
					<option value="64" <?php  if($item['field_length'] == 64) { ?>selected<?php  } ?>>64</option>
					<option value="128" <?php  if($item['field_length'] == 128) { ?>selected<?php  } ?>>128</option>
					<option value="255" <?php  if($item['field_length'] == 255) { ?>selected<?php  } ?>>255</option>
				</select>
			</div>
		</div>
		<div class="form-group">
