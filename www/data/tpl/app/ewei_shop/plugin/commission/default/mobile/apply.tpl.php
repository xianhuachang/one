...
<script id='tpl_main' type='text/html'>
 <div class="balance_img"><i class="fa fa-cny"></i></div>
    ...
    <div class="balance_sub balance_sub2 <%if !cansettle%>disabled<%/if%>"  data-type="1">提现到微信</div>
    <div class="balance_sub3" onclick="location.href='<?php  echo $this->createPluginMobileUrl('commission/log')?>'">提现记录</div>
</script>
