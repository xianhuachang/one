    	...
    	<div class="panel panel-default">
            ...
            <div class="panel-body">
				...
				<div class="form-group">
					...
					<div class="col-xs-12 col-sm-9">
						<input type="text" class="form-control" name="alltotal" value="<?php  if(!empty($activity['alltotal'])) { ?><?php  echo $activity['alltotal'];?><?php  } else { ?>1<?php  } ?>" />
				...
				<div class="form-group">
					...
					<div class="col-xs-12 col-sm-9">
						<input type="text" class="form-control" name="mobile" value="<?php  echo $activity['mobile'];?>" maxlength="11" />
					</div>
				</div>
            </div>
        </div>
