        ...
        <table class="table table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php  if(empty($row['type'])) { ?>余额<?php  } else { ?>微信<?php  } ?></td>
                    <td><?php  echo $row['commission'];?></td>
                     <?php  if($status>=1) { ?>
                     <td><?php  echo date('Y-m-d H:i',$row['applytime'])?></td>
                     <?php  } ?>
                     <?php  if($status>=2) { ?>
                    <td><?php  echo date('Y-m-d H:i',$row['checktime'])?></td>
                     <?php  } ?>
                    <?php  if($status>=3) { ?>
                    <td><?php  echo date('Y-m-d H:i',$row['paytime'])?></td>
                    <?php  } ?>
                        <?php  if($status==-1) { ?>
                    <td><?php  echo date('Y-m-d H:i',$row['invalidtime'])?></td>
                    <?php  } ?>
                     <td>
