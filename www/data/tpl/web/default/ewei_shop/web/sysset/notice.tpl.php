                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9 col-xs-12">
                        ...
                        <label class="radio-inline">
                            <input type="radio" value="0" name='notice[newtype]' <?php  if(empty($set['notice']['newtype'])) { ?>checked<?php  } ?> /> 下单通知
                        </label>
                        <label class="radio-inline">
                            <input type="radio" value="1" name='notice[newtype]' <?php  if($set['notice']['newtype']==1) { ?>checked<?php  } ?> /> 付款通知
                        </label>
                        <div class="help-block">通知商家方式</div>
                        <?php  } else { ?>
                        <input type="hidden" name="notice[newtype]" value="<?php  echo $set['notice']['newtype'];?>" />
                        <div class="form-control-static"><?php  if(empty($set['notice']['newtype'])) { ?>下单通知<?php  } else { ?>付款通知<?php  } ?></div>
                        <?php  } ?>
                    </div>
                </div>
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                    ...
                    <div class="col-sm-9 col-xs-12">
                        ...
                        <div class="help-block">公众平台模板消息编号:  TM00004</div>
                        <?php  } else { ?>
