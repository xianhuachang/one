        ...
        <div class='panel panel-default'>
            ...
            <div class='panel-body'>
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                    <label class="col-xs-12 col-sm-3 col-md-2 control-label"><span style='color:red'>*</span>  所属角色</label>
                    <div class="col-sm-9 col-xs-12">
                         <?php if( ce('perm.user' ,$item) ) { ?>
   ...
   $(function(){
        ...
        $(':input[name=submit]').click(function(){
           ...
           if ($(':input[name=username]').isEmpty()) {
            ...
            <?php  } ?> 
            if ($(':input[name=role]').isEmpty()) {
                Tip.focus($(':input[name=role]'), '请选择用户角色!');
                return;
            }
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-12 col-sm-8 col-lg-9">
                        <select name="roleid" class='form-control'>
                            <option value="" <?php  if(empty($_GPC['status'])) { ?> selected<?php  } ?>></option>
