...
<?php  if($total>0) { ?>
<div class="team_tab">
    <div class="team_nav team_navon" data-level='1'   style='width:100%'>一级(<?php  echo $level1;?>)</div>
    <?php  if($this->set['level']>=2) { ?><div class="team_nav" data-level='2'  style='width:<?php  echo $tabwidth;?>%;display: none;'>二级(<?php  echo $level2;?>)</div><?php  } ?>
    <?php  if($this->set['level']>=3) { ?><div class="team_nav" data-level='3'  style='width:<?php  echo $tabwidth;?>%;display: none;'>三级(<?php  echo $level3;?>)</div><?php  } ?>
</div>
<?php  } ?>
...
<script id='tpl_team' type='text/html'>
    ...
    <div class="team_list">
        ...
        <div class="num">+<%user.commission_total%></div>
    </div>
    <%/each%>
</script>
<script id='tpl_empty' type='text/html'>
    <div class="team_no"><i class="fa fa-users" style="font-size:100px;"></i><br><span style="line-height:18px; font-size:16px;">您还没有相关推广团队成员~</span></div>
</script>
