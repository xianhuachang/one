            ...
            <div class='panel-body'>                
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                    ...
                    <div class="col-sm-9 col-xs-12">
                         <input type='text' class='form-control' name='age' value='<?php  echo $item['age'];?>' />
                    </div>
                </div>
                 <div class="form-group">
                    <label class="col-xs-12 col-sm-3 col-md-2 control-label">用户职业</label>
                    <div class="col-sm-9 col-xs-12">
                         <input type='text' class='form-control' name='career' value='<?php  echo $item['career'];?>' />
                    </div>
                </div>
                 <div class="form-group">
