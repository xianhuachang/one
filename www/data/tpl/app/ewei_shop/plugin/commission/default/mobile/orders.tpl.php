...
<script id='tpl_empty' type='text/html'>
    <div class="order_no"><i class="fa fa-file-text-o" style="font-size:100px;"></i><br><span style="line-height:18px; font-size:16px;">您还没有相关推广订单~</span></div>
</script>
...
function bindScroller(){
        ...
        $(window).scroll(function () {
            ...
            if ($(document).height() <= totalheight) {
                ...
                if (stop == true) {
                    ...
                    page++;
                    core.pjson('commission/orders', {status:current_status,page: page}, function (morejson) {
                        stop = true;
        ...
        function getOrder(status) {
            ...
            core.pjson('commission/orders', {status:status, page: page}, function (json) {
