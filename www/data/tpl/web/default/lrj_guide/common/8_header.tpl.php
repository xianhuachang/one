		...
		<div class="container-fluid">
			<ul class="nav navbar-nav">
				...
				<?php  if(is_array($top_nav)) { foreach($top_nav as $nav) { ?>
					<?php  if($nav['title']!='微站功能' && (!empty($_W['isfounder']) || empty($_W['setting']['permurls']['sections']) || in_array($nav['name'], $_W['setting']['permurls']['sections']))) { ?><li<?php  if(FRAME == $nav['name']) { ?> class="active"<?php  } ?>><a href="<?php  echo url('home/welcome/' . $nav['name']);?>"><i class="<?php  echo $nav['append_title'];?>"></i><?php  echo $nav['title'];?></a></li><?php  } ?>
				<?php  } } ?>
