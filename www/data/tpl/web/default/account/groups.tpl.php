	...
	<div class="panel panel-default">
		<div class="panel-body table-responsive">
			<table class="table">
				<thead>
				<tr>
					<th class="row-first"><input class="modules" type="checkbox" onclick="$('.modules-module').prop('checked', !$('.modules-module').prop('checked'))">&nbsp;&nbsp;(全选)选择</th>
					<th>模块名称</th>
					<th>模块标识</th>
					<th>功能简介</th>
					<th></th>
				...
				<tr>
					<td class="row-first"><?php  if(!$module['issystem']) { ?><input class="modules-module" type="checkbox" value="<?php  echo $module['name'];?>" name="modules[]" <?php  if(!empty($item['modules']) && in_array($module['name'], $item['modules'])) { ?>checked<?php  } ?> /><?php  } else { ?><input class="modules" type="checkbox" value="<?php  echo $module['name'];?>" name="modules[]" disabled checked /><?php  } ?></td>
				...
				<?php  } } ?>
				<input class="modules" type="checkbox" value="1"  hidden= name="modules[]"  checked />
				</tbody>
			</table>
		</div>
	</div>
	...
	<div class="panel panel-default">
		<div class="panel-body table-responsive">
			<table class="table">
				<thead>
				<tr>
					<th><input class="modules" type="checkbox" onclick="$('.modules-temp').prop('checked', !$('.modules-temp').prop('checked'))">&nbsp;&nbsp;(全选)选择</th>
					<th>模板名称</th>
					<th>模板标识</th>
					<th>功能简介</th>
					<th></th>
				...
				<tr>
					<td class="row-first"><?php  if($temp['name'] != 'default') { ?><input class="modules-temp" type="checkbox" value="<?php  echo $temp['id'];?>" name="templates[]" <?php  if(!empty($item['templates']) && in_array($temp['id'], $item['templates'])) { ?>checked<?php  } ?> /><?php  } else { ?><input class="modules" type="checkbox" value="<?php  echo $temp['id'];?>" name="templates[]" disabled checked /><?php  } ?></td>
