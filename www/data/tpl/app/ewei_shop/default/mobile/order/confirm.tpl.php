...
<style type="text/css">
    ...
    .addorder_exp,.addorder_cs {height:42px;  background:#fff; padding:5px; border-bottom:1px solid #eaeaea; line-height:42px; font-size:16px; color:#333;}
    .addorder_exp .t1,.addorder_cs .t1 {height:42px; width:auto; float:left;padding-left:10px;}
    .addorder_exp .t2,.addorder_cs .t2 {height:42px; width:auto; float:right;}
...
.addorder_price .line .nav .on {margin-left:19px;}
 #deliverTypeAll,#deliverTypeSplit{height: 13px;width: 13px;border: none;}
</style>
...
<script id='tpl_confirm_info' type='text/html'>
    ...
    <div class="carrier_input_info" style='display:none' >
 	...
 	<%if member.cs==1%>
 	<div class="addorder_cs" id='cs' >
        <div class="t1">为她下单</div>
        <div class="t2"><input type="text" id="customPhone" style="border: 1px solid silver;height: 25px;"></div>
    </div>
    <%/if%>
    <%if dispatch%>
    <div class="addorder_exp" id='dispatch_select' >
        ...
        <div class="t2"><span class='dispatchname'><%dispatch.dispatchname%></span> <span id='dispatchprice' class='dispatchprice'><%dispatch.price%></span>元</div>
    </div>
    <%/if%>
    ...
    <div class="addorder_good">
        ...
        <input type="hidden" id="deliverType" value="1"/>
    ...
    require(['tpl', 'core'], function(tpl, core) {
		...
		$("input[type=radio]").each(function(){
			$(this).click(function(){
				...
				$("input[type=radio]").css("background","gray");
        ...
        $('.paysub').click(function() {
            ...
            var customPhone= $.trim($("#customPhone").val());
            if (goods == '') {
