...
<script id='goods_info'  type='text/html'>
    ...
    <div class="good_info1">
        ...
        <div class="other">
            ...
            <div class='right'>
                 <span id="stockcontainer">库存:<span id="stock"><%goods.sale_quotas%></span></span> 销量:<%goods.sales%><%goods.unit%></div>
            </div>
    ...
    <%if stores.length>=3%>
     ...
     <%/if%>
    <div class="good_speci" <%if goods.canbuy && goods.total!=0 && goods.timebuy=='0' && goods.userbuy=='1'  && goods.groupbuy=='1'  && goods.levelbuy=='1'%> onClick="choose()"<%/if%>>
        <%if goods.canbuy%>
            <%if goods.istime=='1'%>
