		...
		<input type="hidden" name="a" value="coupon" />
			<div class="form-group">
				...
				<div class="col-sm-7 col-lg-9 col-xs-12">
					<a href="<?php  echo url('activity/coupon')?>" class="btn <?php  if($_GPC['a'] == 'coupon') { ?>btn-primary<?php  } else { ?>btn-default<?php  } ?>">折扣券</a>
					<a href="<?php  echo url('activity/token')?>" class="btn <?php  if($_GPC['a'] == 'token') { ?>btn-primary<?php  } else { ?>btn-default<?php  } ?>">代金券</a>
				</div>
			</div>
			<div class="form-group">
