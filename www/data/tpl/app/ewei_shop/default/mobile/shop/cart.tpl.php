...
.cart_good .info .inner .optionsel {height:30px; width:70%; float:left; line-height:30px; font-size:14px; color:#999; border-bottom:1px solid #999;}
             ...
             <div class="cart_good" 
                 ...
                 <div class="info">
                     ...
                     <div class="other">
                           ...
                           <div class="num" style="display:none"><div class="leftnav">-</div><input type="text" class="shownum" value="<%value.total%>" /><div class="rightnav">+</div>
                    </div>
                </div>
            </div>
                        ...
                        $('.sub').click(function(){
                            ...
                            core.json('shop/cart',{'op':'setoption',id:id,goodsid:goodsid,optionid:optionid},function(json){
                                  if(json.status==1){
                                       ...
                                       $('.price').html(json.result.marketprice);
                                       $('.price1').find('span').html(json.result.productprice);
                                       $('.totalprice').html(json.result.marketprice);
                                 }
                                 else{
                                     core.tip.show('设置失败');
                                 }
