    ...
    <form action="" method="post" class="form-horizontal form" enctype="multipart/form-data" >
        ...
        <div class="panel panel-default">
            <div class='panel-body'>  
                ...
                <div class="form-group">
                    <label class="col-xs-12 col-sm-3 col-md-2 control-label">总店管家人数</label>
                    <div class="col-sm-9 col-xs-12">
                        <?php if(cv('sysset.save.shop')) { ?>
                        <input type="text" name="shop[steward]" class="form-control" value="<?php  echo $set['shop']['steward'];?>" />
                        <?php  } else { ?>
                        <input type="hidden" name="shop[steward]" value="<?php  echo $set['shop']['steward'];?>"/>
                        <div class='form-control-static'><?php  echo $set['shop']['steward'];?></div>
                        <?php  } ?>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-xs-12 col-sm-3 col-md-2 control-label">下级队友人数</label>
                    <div class="col-sm-9 col-xs-12">
                        <?php if(cv('sysset.save.shop')) { ?>
                        <input type="text" name="shop[subordinate]" class="form-control" value="<?php  echo $set['shop']['subordinate'];?>" />
                        <?php  } else { ?>
                        <input type="hidden" name="shop[subordinate]" value="<?php  echo $set['shop']['subordinate'];?>"/>
                        <div class='form-control-static'><?php  echo $set['shop']['steward'];?></div>
                        <?php  } ?>
                    </div>
                </div>                
              ...
              <!--  <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9 col-xs-12">
                        ...
                        <span class='help-block'>推广海报，建议尺寸640*1225</span>
                        <?php  } else { ?>
