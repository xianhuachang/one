<?php defined('IN_IA') or exit('Access Denied');?>			</div>
		...
		<div class="center-block footer" role="footer">
			...
			<div class="text-center">
				<?php  if(empty($_W['setting']['copyright']['footerleft'])) { ?>Powered by <a href="www.igzlrj.com"><b>路仁甲</b></a> v<?php echo IMS_VERSION;?> &copy; 2016 <a href="http://www.igzlrj.com">www.igzlrj.com</a><?php  } else { ?><?php  echo $_W['setting']['copyright']['footerleft'];?><?php  } ?>
			</div>
		</div>
	</div>
