...
<script id='tpl_main' type='text/html'>
 <div class="page_topbar">
    ...
    <%if hascommission%>
        <div class="title">推广信息提醒</div>
        <div class="main">
             <div class="line"><div class="text">成为推广商通知</div><div  class="nav"  notice="commission_become"  on="<%notice.commission_become%>"><nav></nav></div></div>
