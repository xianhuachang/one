    ...
    public function setFooter()
    {
        ...
        if (p('commission')) {
            ...
            if ($_GPC['do'] == 'plugin') {
                ...
                $this->footer['second'] = array('text' => '推广中心', 'ico' => 'sitemap', 'url' => $this->createPluginMobileUrl('commission'));
            } else {
                if (!$_var_6) {
                    $this->footer['second'] = array('text' => '成为推广商', 'ico' => 'sitemap', 'url' => $this->createPluginMobileUrl('commission/register'));
                } else {
