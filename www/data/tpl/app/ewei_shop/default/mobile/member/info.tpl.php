...
<div id="container"></div>
   <?php  if($ext == 'perfection') { ?>
    <div style="width: 100%;text-align: center;"><label style="color: red;">请完善个人资料再进行评论</label></div>
    <?php  } ?>
<script id="member_info" type="text/html">
    ...
    <div class="info_main">
        ...
        <div class="line"><div class="title">职业</div><div class='info'><div class='inner'><input type="text" id='career' placeholder="请输入职业" value="<%career%>"/></div></div></div>       
        <div class="line">
