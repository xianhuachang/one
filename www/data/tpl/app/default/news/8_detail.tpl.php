...
@keyframes myfirst
{
0%   {transform: translate(0,-30px);opacity: 1;}
...
{
0%   {-webkit-transform: translate(0,-30px);opacity: 1;}
50%  {-webkit-transform: translate(0,-15px);opacity: 0.5;}
...
<div style="width: 100%;position: fixed;bottom: 0;text-align: center;">
	<img src="<?php  echo $_W['siteroot'];?>app/resource/images/app/product-fleches.png" id="downImg"/>
</div>
	...
	$(".page-content").swipe(
                {
                    swipe:function(event, direction, distance, duration, fingerCount) {
                         if(direction == "up"){
                         	var id=<?php  echo ($id%3)+1;?>;
                            var red_url="http://mp.angelbeautyinc.com/app/index.php?i=8&c=entry&id="+id+"&do=detail&m=news";
